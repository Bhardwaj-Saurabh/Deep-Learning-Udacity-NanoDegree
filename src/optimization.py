...
def get_optimizer(
    ...
    if optimizer.lower() == "sgd":
        # Create an instance of the SGD optimizer with the provided parameters
        opt = torch.optim.SGD(
            model.parameters(),  # Pass the model's parameters to be optimized
            lr=learning_rate,
            momentum=momentum,
        ...
        # Create an instance of the Adam optimizer with the provided parameters
